          ...
          children: [
            Row(
              children: [
                ...
                Text("StyleStack", style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold),),
                SizedBox(width: 10),
                Text("- Home")
              ],
            ),
        ...
        child: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
              icon: Icon(Icons.home, color: _currentIndex == 0 ? const Color.fromARGB(255, 183, 38, 180) : const Color.fromARGB(255, 57, 54, 54), 
              size: 35,
                ...
                Shadow(
                  color: const Color.fromARGB(255, 183, 38, 180).withValues(alpha: 0.5), 
                  blurRadius: 30.0,
                )] : [],
              ),
              label: "Home",
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.favorite, color: _currentIndex == 1 ? const Color.fromARGB(255, 183, 38, 180) : const Color.fromARGB(255, 57, 54, 54), size: 35,
            ...
            BottomNavigationBarItem(
              icon: Icon(
                Icons.add,
                color: _currentIndex == 2 ? const Color.fromARGB(255, 183, 38, 180) : const Color.fromARGB(255, 57, 54, 54),
                size: 35,
            ...
            BottomNavigationBarItem(
              icon: Icon(Icons.recommend, color: _currentIndex == 3 ? const Color.fromARGB(255, 183, 38, 180) : const Color.fromARGB(255, 57, 54, 54), size: 35,
